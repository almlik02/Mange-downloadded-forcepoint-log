...
:: Decompress all .gz files in the source folder to the destination folder
for %%i in ("%sourceFolder%\*.gz") do (
    :: Check if file is in the log file (already processed)
...
:: Delete decompressed files older than 1 hour using PowerShell
